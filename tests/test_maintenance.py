...
class MaintenanceOrderingTests(unittest.TestCase):
    def test_active_installer_delegates_before_live_mutation(self):
        ...
        for mutation in (
            ...
            "systemctl restart openclaw-health.timer openclaw-vm-snapshot.timer",
        ):
    ...
    def test_update_preflight_and_callback_order(self):
        ...
        for validation in (
            ...
            'for service in openclaw-health.service openclaw-vm-snapshot.service',
        ...
        self.assertLess(
            unlock, UPDATER.index("systemctl start openclaw-health.timer", ready)
        )
    ...
    def test_only_own_timers_are_paused_and_no_service_is_killed_for_drain(self):
        ...
        self.assertIn("openclaw-health.timer openclaw-vm-snapshot.timer", drain)
    ...
    def test_fresh_install_releases_lock_before_starting_timers(self):
        finish = INSTALLER.split(
            "\nsystemctl enable openclaw-health.timer openclaw-vm-snapshot.timer\n", 1
        )[1]
